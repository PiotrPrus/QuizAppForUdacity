...
public class QuizPageSix extends AppCompatActivity {
    ...
    public void goToResults(View view) {
        ...
        Log.d("quizResult", "Result after sixth question is :" + quizScore);
        Intent startResultActivity = new Intent(this, QuizResults.class);
        startResultActivity.putExtra(String.valueOf(R.string.saved_quiz_score), quizScore);

...
public class QuizPageTwo extends AppCompatActivity {
    ...
    public void goToPageThree(View view) {
        ...
        Log.d("quizResult", "Result after second question is :" + quizScore);
        Intent startThirdQuestion = new Intent(this, QuizPageThree.class);
        startThirdQuestion.putExtra(String.valueOf(R.string.saved_quiz_score), quizScore);
        startActivity(startThirdQuestion);
        finish();
    }
